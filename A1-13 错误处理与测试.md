...
**下面例子中的 protect 函保护调用者防止从 g 中抛出的运行时 panic 宕机，并展示 panic 中的信息：**
...
我们会在 [15.5 节](https://learnku.com/docs/the-way-to-go/135-a-pattern-that-handles-errors-with-closures/15.5.md)的 web 应用中使用这种模式。
